...
# if multiple cameras on system, choose the one by changing the index number of default.
...
COUNTER = 0
# indicate if the alarm is going off <True/False>
ALARM_ON = True
	...
	for rect in rects:
		...
		if ear < EYE_AR_THRESH:
			...
			if COUNTER >= EYE_AR_CONSEC_FRAMES:
				...
				# draw an alarm on the frame "DROWSINESS ALERT!"
